                ...
                renderItem={() => (
                    <>
                            ...
                            <View style={styles.Inputroom}>
                                {isListVisible ? (
                                    ...
                                    <TouchableOpacity style={styles.selectContainer} onPress={handlePress}>
                                        {selectedItem ?
                                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1, width: 20, height: 30 }}>{selectedItem}</Text>
                                            :
                                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1 }}>Assigned Room </Text>
                                        }
                        ...
                        <View style={styles.parentInfo}>
                            ...
                            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('AddAuthorizedPickup')}>
                            ...
                            <View style={styles.removalModalContainer}>
                                <View style={styles.progressModal}>
                                    ...
                                    <View style={styles.modalContent}>
                                        ...
                                        <Text style={styles.progressModalsub}>Are you sure you want to remove this student profile?</Text>
                                    </View>
