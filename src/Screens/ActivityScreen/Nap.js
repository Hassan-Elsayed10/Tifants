...
export default function Nap() {
    ...
    const [isFocusedNap, setIsFocusedNap] = useState(false);
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.row} >
                ...
                <Text style={styles.text}>Nap</Text>
            </View>

            <TouchableOpacity onPress={()=>navigation.navigate('SelectionNap')}>
            ...
            <View style={styles.togglContainer}>
                <Text style={styles.toggelText}>Nap Check Reminder Repeating every 15 mins</Text>
                <TouchableOpacity onPress={handleToggleNap} >
                    <Icon
                        name={isFocusedNap ? 'toggle-on' : 'toggle-off'}
                        size={30}
                        color={isFocusedNap ? '#475AD7' : '#D9D9D9'}
                    />
                </TouchableOpacity>
            </View>
