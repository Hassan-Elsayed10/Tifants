...
export default function Incident() {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('SelectionIncident')}>
                ...
                {isListVisible ? (
                    ...
                    <TouchableOpacity style={styles.selectContainer} onPress={handlePress}>
                        {selectedItem ?
                            ...
                            :
                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1 }}>Nature of Injury or Incident</Text>
                        }
                ...
                {isListDiaperVisible ? (
                    ...
                    <TouchableOpacity style={styles.selectContainer} onPress={handlePressDiaper}>
                        {selectedDiaper ?
                            ...
                            :
                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1 }}>First Aid Administered</Text>
                        }
                        <Image source={require('../../../Assets/Frame(4).png')} />
                    </TouchableOpacity>
                }
            ...
            <View style={styles.togglContainer}>
                <Text style={styles.toggelText}>Was the parent notified?</Text>
            ...
            <View style={{ alignItems: 'center' }}>
                <View style={styles.InputMsg}>
                    <Text style={styles.stakedText}>Additional Notes</Text>
                    <TextInput
