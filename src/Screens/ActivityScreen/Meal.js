...
export default function Meal() {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('SelectionMeal')}>
                ...
                {isListVisible ? (
                    ...
                    <TouchableOpacity style={styles.selectContainer} onPress={handlePress}>
                        {selectedItem ?
                            ...
                            :
                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1 }}>Meal Type</Text>
                        }
                ...
                {isListQuantityVisible ? (
                    ...
                    <TouchableOpacity style={styles.selectContainer} onPress={handleQuantityPress}>
                        {selectedQuantity ?
                            ...
                            :
                            <Text style={{ color: '#565656', fontSize: 16, fontWeight: '500', flex: 1 }}>Quantity</Text>
                        }
                        <Image source={require('../../../Assets/Frame(4).png')} />
                    </TouchableOpacity>
                }
            ...
            <View style={{ alignItems: 'center' }}>
                <View style={styles.InputMsg}>
                    ...
                    <View style={{flex: 1, flexDirection: 'row',alignItems:'flex-end' }}>
                        <TouchableOpacity style={styles.wrrapborder3}>
                            <View style={styles.wrrapIcon}>
                                <Image source={require('../../../Assets/vuesax/Group36688s.png')} />
                            </View>
                        </TouchableOpacity>
