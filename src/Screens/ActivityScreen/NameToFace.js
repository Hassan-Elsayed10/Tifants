...
export default function NameToFace() {
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.row} >
                ...
                <Text style={styles.text}>Name to Face</Text>
            </View>
            <TouchableOpacity onPress={()=>navigation.navigate('SelectionNameToFace')}>
            ...
            <View style={styles.togglContainer}>
                <Text style={styles.toggelText}>Staff only (not visible to parents)</Text>
