...
export default function ReceivePaymentSubmit() {
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.row} >
                ...
                <Text style={styles.text}>ReceivePayment</Text>
                {/* <TouchableOpacity>
            ...
            <View style={styles.personInfo}>
                ...
                <View style={styles.Input}>
                    <Text style={styles.stakedText}>Mode</Text>
                    <TextInput
                        style={styles.textInput}
                        placeholder="Cash"
                        placeholderTextColor={'#565656'}
            ...
            <View style={{ flex: 2,marginTop:'40%'}}>
                <TouchableOpacity style={styles.button1} onPress={() => navigation.navigate('AddCredit')} >
